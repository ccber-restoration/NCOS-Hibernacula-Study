...
save_kable(t1, "species_table_pt_2.html")

# Use webshot2 to save as PNG image
webshot("species_table_pt_2.html", here("figures","species_table_pt_2.png"), zoom = 2, vwidth = 1800)
```
...
# Save the kable as an HTML file
save_kable(t1_pt1, "species_table_pt1.html")

# Use webshot2 to save as PNG image
webshot("species_table_pt1.html", here("figures","species_table_pt1.png"), zoom = 2, vwidth = 550)
...
save_kable(t1_hourly, "species_table_hourly.html")
webshot("species_table_hourly.html", here("figures", "species_table_hourly_pt_1_and_2.png"), zoom = 2, vwidth = 1800)
